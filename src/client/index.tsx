...
const USER_KEY = "online-stranger-chat-user";
...
async function getRegions(country: string): Promise<string[]> {
  if (!country) return [];
...
function Avatar({
  ...
  return (
    <div
      className={`avatar avatar-${genderColor(
        user.gender,
      )} avatar-${size}`}
      title={user.gender}
    >
    ...
    <div className="brand">
      ...
      <div>
        ...
        <div className="brand-subtitle">
          No Login • Meet People • Chat Freely
        </div>
      </div>
    </div>
  );
